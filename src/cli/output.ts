...
export const ErrorCodes = {
  ...
  AGENT_REGISTRY_REFRESH_FAILED: 'AGENT_REGISTRY_REFRESH_FAILED',
  ...
  PROXY_PROFILE_TEST_FAILED: 'PROXY_PROFILE_TEST_FAILED',
  PROXY_REVISION_CONFLICT: 'PROXY_REVISION_CONFLICT',
  PROXY_PROFILE_EXISTS: 'PROXY_PROFILE_EXISTS',
  PROXY_PROFILE_NOT_FOUND: 'PROXY_PROFILE_NOT_FOUND',
  PROXY_PROFILE_IN_USE: 'PROXY_PROFILE_IN_USE',
  PROXY_VALIDATION_ERROR: 'PROXY_VALIDATION_ERROR',
  PROXY_INPUT_FILE_INSECURE: 'PROXY_INPUT_FILE_INSECURE',
  PROXY_INPUT_FILE_NOT_FOUND: 'PROXY_INPUT_FILE_NOT_FOUND',
  PROXY_INPUT_JSON_INVALID: 'PROXY_INPUT_JSON_INVALID',
  PROXY_INPUT_SCHEMA_INVALID: 'PROXY_INPUT_SCHEMA_INVALID',
  PROXY_MISSING_ARGUMENT: 'PROXY_MISSING_ARGUMENT',
